...
import cz.cas.lib.proarc.webapp.client.widget.mods.NdkMonographSupplementForm;
...
/**
 * The old print supplement form based on the NDK supplement of monograph volume.
 * It adds:
 * <ul>
 * <li>{@code typeOfResource@manuscript='yes' for /mods/typeOfResource/text()='text'}</li>
 * </ul>
 * It removes:
 * <ul>
 * <li>{@code 'cartographic|notated music|...' values from menu for /mods/typeOfResource/text()}</li>
 * </ul>

 * Version 1.1_2
 *
 * @author Jan Pokorsky
 * @see NdkMonographSupplementForm
 */
public final class OldPrintSupplementForm {
