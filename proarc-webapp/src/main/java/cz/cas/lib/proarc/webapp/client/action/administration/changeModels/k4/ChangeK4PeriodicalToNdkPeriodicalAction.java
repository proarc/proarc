 ...
 * @author Lukas Sykora
 */
public class ChangeK4PeriodicalToNdkPeriodicalAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeK4PeriodicalToNdkPeriodicalAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeK4PeriodicalToNdkPeriodicalAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeK4PeriodicalToNdkPeriodicalAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && K4Plugin.MODEL_PERIODICAL.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeK4PeriodicalToNdkPeriodical();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeK4PeriodicalToNdkPeriodicalAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
