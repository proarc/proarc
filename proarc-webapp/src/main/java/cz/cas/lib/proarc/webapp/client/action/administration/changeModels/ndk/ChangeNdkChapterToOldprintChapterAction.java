...
/**
 * Change Ndk Chapter to OldPrint Chapter
 *
 * @author Lukas Sykora
 */
public class ChangeNdkChapterToOldprintChapterAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkChapterToOldprintChapterAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkChapterToOldPrintChapterAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkChapterToOldprintChapterAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && NdkPlugin.MODEL_CHAPTER.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkChapterToOldPrintChapter();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkChapterToOldPrintChapterAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
