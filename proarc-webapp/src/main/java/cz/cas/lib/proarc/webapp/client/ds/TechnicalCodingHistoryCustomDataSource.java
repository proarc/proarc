...
public class TechnicalCodingHistoryCustomDataSource extends ProarcDataSource implements ModsConstants {

    private static final Logger LOG = Logger.getLogger(TechnicalCodingHistoryCustomDataSource.class.getName());

    public static final String ID = "TechnicalCodingHistoryCustomDataSource";
    ...
    public TechnicalCodingHistoryCustomDataSource() {
        setID(ID);
        setDataURL(RestConfig.URL_DIGOBJECT_TECHNICAL_METADATA_CODING_HISTORY);
    ...
    public static TechnicalCodingHistoryCustomDataSource getInstance() {
        TechnicalCodingHistoryCustomDataSource ds = (TechnicalCodingHistoryCustomDataSource) DataSource.get(ID);
        ds = ds != null ? ds : new TechnicalCodingHistoryCustomDataSource();
        return ds;
    }
    ...
    public static class DescriptionMetadata {
        ...
        public Record getDescription() {
            Record customModsRecord = wrapper.getAttributeAsRecord(TechnicalCodingHistoryCustomDataSource.FIELD_DATA);
            return customModsRecord;
        }

        public void setDescription(Record r) {
            wrapper.setAttribute(TechnicalCodingHistoryCustomDataSource.FIELD_DATA, r);
        }
    }
