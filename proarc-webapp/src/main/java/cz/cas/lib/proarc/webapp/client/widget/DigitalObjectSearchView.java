...
public final class DigitalObjectSearchView implements Selectable<Record>, RefreshAction.Refreshable {
    ...
    private DynamicForm createFilter() {
        ...
        form.setFields(filterType, createSpacerItem("100%", null),
                ...
                createAdvancedItem(DigitalObjectResourceApi.SEARCH_OWNER_PARAM,
                        i18n.DigitalObjectSearchView_FilterAdvancedOwner_Title(), showIfQuery), createSpacerItem("100%", showIfQuery),
    ...
    private FormItem createOwnerItem(String title, FormItemIfFunction showIf) {
        SelectItem item = new SelectItem(DigitalObjectResourceApi.SEARCH_QUERY_CREATOR_PARAM, title);
        item.setWidth("100%");
        item.setColSpan(3);
