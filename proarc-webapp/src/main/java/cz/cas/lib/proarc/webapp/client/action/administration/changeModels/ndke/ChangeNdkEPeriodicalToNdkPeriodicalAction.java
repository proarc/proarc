...
/**
 * Change Ndk Periodical to Ndk EPeriodical
 *
 * @author Lukas Sykora
 */
public class ChangeNdkEPeriodicalToNdkPeriodicalAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkEPeriodicalToNdkPeriodicalAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkEPeriodicalToNdkPeriodicalAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkEPeriodicalToNdkPeriodicalAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && NdkEbornPlugin.MODEL_EPERIODICAL.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
        ...
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkEPeriodicalToNdkPeriodicalAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
