...
/**
 * Change OldPrint Cartographic to Ndk Cartographic
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintCartographicToNdkCartographicAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintCartographicToNdkCartographicAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintCartographicToNdkCartographicAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintCartographicToNdkCartographicAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && OldPrintPlugin.MODEL_CARTOGRAPHIC.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintCartographicToNdkCartographic();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintCartographicToNdkCartographicAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
