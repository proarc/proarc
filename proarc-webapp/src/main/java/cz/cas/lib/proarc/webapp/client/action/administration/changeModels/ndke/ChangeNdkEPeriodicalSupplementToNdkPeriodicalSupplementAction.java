...
/**
 * Change Ndk EPeriodical Supplement to Ndk Periodical Supplement
 *
 * @author Lukas Sykora
 */
public class ChangeNdkEPeriodicalSupplementToNdkPeriodicalSupplementAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkEPeriodicalSupplementToNdkPeriodicalSupplementAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkEPeriodicalSupplementToNdkPeriodicalSupplementAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkEPeriodicalSupplementToNdkPeriodicalSupplementAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (NdkEbornPlugin.MODEL_EPERIODICALSUPPLEMENT.equals(modelId) || NdkEbornPlugin.MODEL_EPERIODICALISSUE.equals(modelId)
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkEPeriodicalSupplementToNdkPeriodicalSupplement();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkEPeriodicalSupplementToNdkPeriodicalSupplementAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
