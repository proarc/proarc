...
/**
 * Change Oldprint Monograph Supplement to Ndk Monograph Supplement
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintMonographSupplementToNdkMonographSupplementAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintMonographSupplementToNdkMonographSupplementAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintMonographSupplementToNdkMonographSupplementAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintMonographSupplementToNdkMonographSupplementAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && OldPrintPlugin.MODEL_SUPPLEMENT.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintMonographSupplementToNdkMonographSupplement();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintMonographSupplementToNdkMonographSupplementAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
