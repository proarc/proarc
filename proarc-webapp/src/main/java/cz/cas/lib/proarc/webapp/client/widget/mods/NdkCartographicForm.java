    ...
    public Form build() {
        ...
        modsFields.add(new FieldBuilder("titleInfo").setTitle("Title Info - M").setMaxOccurrences(10)
                ...
                .addField(new FieldBuilder("title").setMaxOccurrences(1)
                    .addField(new FieldBuilder("value").setTitle("Title - M").setMaxOccurrences(1).setType(Field.TEXT).setRequired(true)
                        .setHint("Název kartografického dokumentu.")
                    .createField()) // value
                    // lang, String
                    // xmlLang, lang
                    // script, String
                ...
                .addField(new FieldBuilder("subTitle").setMaxOccurrences(1)
                    .addField(new FieldBuilder("value").setTitle("Subtitle - MA").setMaxOccurrences(1).setType(Field.TEXT)
                        .setHint("Podnázev kartografického dokumentu.")
                    .createField()) // value
        ...
        modsFields.add(new FieldBuilder("name").setMaxOccurrences(10).setTitle("Name - MA")
                .setHint("Údaje o odpovědnosti za svazek."
                    + "<p>Pokud má kartografický dokument jiné původce než"
        ...
        modsFields.add(new FieldBuilder("typeOfResource").setMaxOccurrences(1)
                ...
                .addField(new FieldBuilder("value").setTitle("Type of Resource - R").setMaxOccurrences(1).setType(Field.SELECT)
                    .setHint("Popis charakteristiky typu nebo obsahu zdroje.<p>Pro kartografické dokumenty hodnota „cartographic“.")
        ...
        modsFields.add(new FieldBuilder("genre").setTitle("Genre - M").setMaxOccurrences(10)
                .setHint("Bližší údaje o typu dokumentu.<p>Pro kartografické dokumenty hodnota “cartographic”.")
        ...
        modsFields.add(new FieldBuilder("originInfo").setTitle("Origin Info - M").setMaxOccurrences(10)
...
//                    .addField(new FieldBuilder("authority").setTitle("Authority").setMaxOccurrences(1).setType(Field.TEXT).setWidth("200").createField())
                ...
                .addField(new FieldBuilder("cartographics").setTitle("Cartographics - MA").setMaxOccurrences(1)
                    .setHint("Kartografické údaje.")
                    // @authorityAttributeGroup: @authority, @authorityURI, @valueURI
                    // scale, 0..1, type="stringPlusLanguage"
                    .addField(new FieldBuilder("scale").setMaxOccurrences(1)
                        .addField(new FieldBuilder("value").setTitle("Scale - MA").setMaxOccurrences(1).setType(Field.TEXT)
                            .setHint("Měřítko.")
                        .createField()) // value
                    .createField()) // scale
                    // projection, 0..1, type="stringPlusLanguage"
                    // coordinates, 0..n, type="stringPlusLanguage"
                    .addField(new FieldBuilder("coordinates").setTitle("Coordinates - MA").setMaxOccurrences(10)
                        .setHint("Souřadnice.")
                        .addField(new FieldBuilder("value").setMaxOccurrences(1).setType(Field.TEXT)
                            .setHint("Souřadnice.")
                        .createField()) // value
...
//                    .addMapValue("issn", "ISSN")
        ...
        modsFields.add(new FieldBuilder("location").setTitle("Location - MA").setMaxOccurrences(10)
