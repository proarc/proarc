...
/**
 * Change Ndk Monograph Supplement to OldPrint Monograph Supplement
 *
 * @author Lukas Sykora
 */
public class ChangeNdkMonographSupplementToOldprintMonographSupplementAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkMonographSupplementToOldprintMonographSupplementAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkMonographSupplementToOldPrintMonographSupplementAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkMonographSupplementToOldprintMonographSupplementAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && NdkPlugin.MODEL_MONOGRAPHSUPPLEMENT.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkMonographSupplementToOldPrintMonographSupplement();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkMonographSupplementToOldPrintMonographSupplementAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
