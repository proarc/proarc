...
/**
 * Change Ndk EPeriodical Volume to Ndk Periodical Volume
 *
 * @author Lukas Sykora
 */
public class ChangeNdkEPeriodicalVolumeToNdkPeriodicalVolumeAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkEPeriodicalVolumeToNdkPeriodicalVolumeAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkEPeriodicalVolumeToNdkPeriodicalVolumeAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkEPeriodicalVolumeToNdkPeriodicalVolumeAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (NdkEbornPlugin.MODEL_EPERIODICALVOLUME.equals(modelId) || NdkEbornPlugin.MODEL_EPERIODICAL.equals(modelId)
        ...
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkEPeriodicalVolumeToNdkPeriodicalVolumeAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
