...
/**
 * Change Ndk Monograph Volume to OldPrint Monograph Volume
 *
 * @author Lukas Sykora
 */
public class ChangeNdkMonographVolumeToOldprintMonographVolumeAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkMonographVolumeToOldprintMonographVolumeAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkMonographVolumeToOldPrintMonographVolumeAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkMonographVolumeToOldprintMonographVolumeAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkMonographVolumeToOldPrintMonographVolume();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkMonographVolumeToOldPrintMonographVolumeAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
