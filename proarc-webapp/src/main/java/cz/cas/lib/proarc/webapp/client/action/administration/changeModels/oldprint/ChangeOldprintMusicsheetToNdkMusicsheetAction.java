...
/**
 * Change Oldprint Music Sheet to Ndk Music Sheet
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintMusicsheetToNdkMusicsheetAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintMusicsheetToNdkMusicsheetAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintMusicSheetToNdkMusicSheetAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintMusicsheetToNdkMusicsheetAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintMusicSheetToNdkMusicSheet();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintMusicSheetToNdkMusicSheetAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
