    ...
    public Form build() {
        ...
        modsFields.add(new FieldBuilder("titleInfo").setTitle("Název").setMaxOccurrences(10)
                ...
                .addField(new FieldBuilder("title").setMaxOccurrences(1)
                    .addField(new FieldBuilder("value").setTitle("Název obrázku").setMaxOccurrences(1).setType(Field.COMBO).setRequired(true).setWidth(f.getItemWidth())
                ...
                .addField(new FieldBuilder("subTitle").setMaxOccurrences(1)
                    .addField(new FieldBuilder("value").setTitle("Podnázev obrázku").setMaxOccurrences(1).setType(Field.TEXT).createField())
        ...
        modsFields.add(new FieldBuilder("genre").setTitle("Genre").setMaxOccurrences(1)
                ...
                // stringPlusLanguage: @lang, @xmlLang, @script, @transliteration
                .addField(new FieldBuilder("value").setMaxOccurrences(1).setType(Field.TEXT).setRequired(true).setDefaultValue("picture").createField())
        .createField()); // genre
