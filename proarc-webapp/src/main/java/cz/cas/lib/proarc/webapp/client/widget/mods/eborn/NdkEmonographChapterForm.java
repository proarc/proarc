...
public final class NdkEmonographChapterForm {
        ...
        public Form build() {
            ...
            modsFields.add(new FieldBuilder("language").setTitle("Languages - R").setMaxOccurrences(10)
            ...
            modsFields.add(new FieldBuilder("physicalDescription").setTitle("Physical Description - M").setMaxOccurrences(10)
                    ...
                    .addField(new FieldBuilder("form").setTitle("Form - M").setMaxOccurrences(1)
                            ...
                            .addField(new FieldBuilder("authority").setTitle("Authority - M").setMaxOccurrences(1).setType(Field.COMBO).setDefaultValue("marcform")
            ...
            modsFields.add(new FieldBuilder("abstract").setTitle("Abstract - O").setMaxOccurrences(10)
                    // stringPlusLanguage: @lang, @xmlLang, @script, @transliteration
            ...
            modsFields.add(new FieldBuilder("subject").setTitle("Subject - RA").setMaxOccurrences(10)
                    ...
                    .addField(new FieldBuilder("authority").setTitle("Authority - MA").setMaxOccurrences(1).setType(Field.COMBO)
                            .setHint("Odpovídá hodnotě $2, Konspekt. Při použití volných klíčových slov nepoužívat.")
                    ...
                    .addField(nameInSubject()/*new FieldBuilder("name").setMaxOccurrences(1)
