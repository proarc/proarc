 ...
 */
package cz.cas.lib.proarc.webapp.client.action.administration.changeModels.bdm;
...
/**
 * Change BDM Article to NDK E Article
 *
 * @author Lukas Sykora
 */
public class ChangeBdmArticleToNdkEArticleAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeBdmArticleToNdkEArticleAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeBdmArticleToNdkEArticleAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeBdmArticleToNdkEArticleAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (BornDigitalModsPlugin.MODEL_ARTICLE.equals(modelId) || NdkPlugin.MODEL_PERIODICALISSUE.equals(modelId)
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeBdmArticleToNdkEArticle();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeBdmArticleToNdkEArticleAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
