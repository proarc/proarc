...
/**
 * Change Ndk eMonograph Volume to Ndk eMonograph Unit
 *
 * @author Lukas Sykora
 */
public class ChangeNdkEMonographVolumeToNdkEMonographUnitAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkEMonographVolumeToNdkEMonographUnitAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkEMonographVolumeToNdkEMonographUnitAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkEMonographVolumeToNdkEMonographUnitAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (NdkEbornPlugin.MODEL_EMONOGRAPHVOLUME.equals(modelId))) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkEMonographVolumeToNdkEMonographUnit();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkEMonographVolumeToNdkEMonographUnitAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
