...
/**
 * Change OldPrint Graphic to OldPrint Monograph Volume
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintGraphicToOldPrintMonographVolumeAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintGraphicToOldPrintMonographVolumeAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintGraphicToOldPrintMonographVolumeAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintGraphicToOldPrintMonographVolumeAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && OldPrintPlugin.MODEL_GRAPHICS.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintGraphicToToOldPrintMonographVolume();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintGraphicToOldPrintMonographVolumeAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
