...
/**
 * Change Ndk Article to Ndk EArticle
 *
 * @author Lukas Sykora
 */
public class ChangeNdkArticleToNdkEArticleAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkArticleToNdkEArticleAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkArticleToNdkEArticleAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkArticleToNdkEArticleAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (NdkPlugin.MODEL_ARTICLE.equals(modelId) || NdkPlugin.MODEL_PERIODICALISSUE.equals(modelId)
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkArticleToNdkEArticle();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkArticleToNdkEArticleAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
