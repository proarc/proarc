...
/**
 * Change OldPrint Monograph Volume  to Ndk Monograph Volume
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintMonographVolumeToNdkMonographVolumeAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintMonographVolumeToNdkMonographVolumeAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintMonographVolumeToNdkMonographVolumeAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintMonographVolumeToNdkMonographVolumeAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintMonographVolumeToNdkMonographVolume();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintMonographVolumeToNdkMonographVolumeAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
