...
//                .createField())
                ...
                .addField(new FieldBuilder("title").setMaxOccurrences(1)
                    .addField(new FieldBuilder("value").setTitle("Název periodika").setMaxOccurrences(1).setType(Field.TEXT).setRequired(true).createField())
                    // lang, String
                    // xmlLang, lang
                    // script, String
...
//                .createField()) // subTitle
        ...
        modsFields.add(new FieldBuilder("genre").setMaxOccurrences(1)
                ...
                // stringPlusLanguage: @lang, @xmlLang, @script, @transliteration
                .addField(new FieldBuilder("value").setTitle("Typ přílohy").setMaxOccurrences(1)
