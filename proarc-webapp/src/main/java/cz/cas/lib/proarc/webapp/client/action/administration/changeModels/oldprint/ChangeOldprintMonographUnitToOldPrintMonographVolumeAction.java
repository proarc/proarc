...
/**
 * Change OldPrint Monograph Unit  to OldPrint Monograph Volume
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintMonographUnitToOldPrintMonographVolumeAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintMonographUnitToOldPrintMonographVolumeAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintMonographUnitToOldPrintMonographVolumeAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintMonographUnitToOldPrintMonographVolumeAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (OldPrintPlugin.MODEL_MONOGRAPHUNIT.equals(modelId)) || OldPrintPlugin.MODEL_MONOGRAPHTITLE.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintMonographUnitToOldPrintMonographVolume();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintMonographUnitToOldPrintMonographVolumeAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
