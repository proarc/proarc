...
public abstract class AnnotatedSearchViewItem extends SearchViewItem {
    ...
    @JsonProperty(DigitalObjectResourceApi.MEMBERS_ITEM_CREATED)
    @Override
    ...
    @JsonProperty(DigitalObjectResourceApi.MEMBERS_ITEM_MODEL)
    @Override
    public abstract String getModel();

    @XmlElement(name = DigitalObjectResourceApi.MEMBERS_ITEM_MODIFIED)
    @JsonProperty(DigitalObjectResourceApi.MEMBERS_ITEM_MODIFIED)
    @Override
    public abstract String getModified();

    @XmlElement(name = DigitalObjectResourceApi.MEMBERS_ITEM_OWNER)
    @JsonProperty(DigitalObjectResourceApi.MEMBERS_ITEM_OWNER)
    @Override
    ...
    @JsonProperty(DigitalObjectResourceApi.MEMBERS_ITEM_STATE)
    @Override
    public abstract String getState();

    @XmlElement(name = DigitalObjectResourceApi.MEMBERS_ITEM_PARENT)
    @JsonProperty(DigitalObjectResourceApi.MEMBERS_ITEM_PARENT)
    @Override
