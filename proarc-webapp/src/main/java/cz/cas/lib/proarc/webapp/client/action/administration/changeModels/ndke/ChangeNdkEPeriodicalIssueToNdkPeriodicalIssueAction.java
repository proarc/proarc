...
/**
 * Change Ndk EPeriodical Issue to Ndk Periodical Issue
 *
 * @author Lukas Sykora
 */
public class ChangeNdkEPeriodicalIssueToNdkPeriodicalIssueAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkEPeriodicalIssueToNdkPeriodicalIssueAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkEPeriodicalIssueToNdkPeriodicalIssueAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkEPeriodicalIssueToNdkPeriodicalIssueAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (NdkEbornPlugin.MODEL_EPERIODICALISSUE.equals(modelId) || NdkEbornPlugin.MODEL_EPERIODICALVOLUME.equals(modelId)
                        || NdkEbornPlugin.MODEL_EPERIODICAL.equals(modelId) || NdkPlugin.MODEL_PERIODICAL.equals(modelId)
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkEPeriodicalVolumeToNdkPeriodicalVolume();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkEPeriodicalIssueToNdkPeriodicalIssueAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
