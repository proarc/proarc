...
/**
 * Change Ndk Monograph Unit to Ndk Monograph Volume
 *
 * @author Lukas Sykora
 */
public class ChangeNdkMonographUnitToNdkMonographVolumeAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkMonographUnitToNdkMonographVolumeAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkMonographUnitToNdkMonographVolumeAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkMonographUnitToNdkMonographVolumeAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && NdkPlugin.MODEL_MONOGRAPHUNIT.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkMonographUnitToNdkMonographVolume();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkMonographUnitToNdkMonographVolumeAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
