 ...
 * @author Lukas Sykora
 */
public class ChangeNdkPeriodicalToNdkEPeriodicalAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkPeriodicalToNdkEPeriodicalAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkPeriodicalToNdkEPeriodicalAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkPeriodicalToNdkEPeriodicalAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && NdkPlugin.MODEL_PERIODICAL.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
        ...
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkPeriodicalToNdkEPeriodicalAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
