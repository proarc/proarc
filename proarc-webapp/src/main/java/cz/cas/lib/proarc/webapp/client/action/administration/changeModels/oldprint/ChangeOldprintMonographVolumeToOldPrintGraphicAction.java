...
/**
 * Change OldPrint Monograph Volume  to OldPrint Graphic
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintMonographVolumeToOldPrintGraphicAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintMonographVolumeToOldPrintGraphicAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintMonographVolumeToOldPrintGraphicAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintMonographVolumeToOldPrintGraphicAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintMonographVolumeToOldPrintGraphic();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintMonographVolumeToOldPrintGraphicAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
