...
//        lgfFolder.setAutoFitWidth(false);
        ...
        ListGridField lgfProfile = new ListGridField(ImportBatchDataSource.FIELD_PROFILE_ID,
                i18n.ImportSourceChooser_OptionProfile_Title());
        lgfProfile.setWidth(150);
    ...
    private final class ResumeAction extends AbstractAction {
        ...
        public boolean accept(ActionEvent event) {
            ...
            if (record != null && !record.isArchive() && !record.isKrameirus() && !record.isReplaceStream() && !record.isNdk()) {
    ...
    private final  class ParentAction extends AbstractAction {
        ...
        public boolean accept(ActionEvent event) {
            ...
            return batch != null && batch.getParentPid() != null && !batch.isArchive() && !batch.isKrameirus() && !batch.isReplaceStream() && !batch.isNdk();
        }
