    ...
    public abstract class AnnotatedDevice extends Device {
        ...
        @JsonProperty(DeviceResourceApi.DEVICE_ITEM_ID)
        @Override
        public String getId() {
            return super.getId();
        }
        ...
        @JsonProperty(DeviceResourceApi.DEVICE_ITEM_LABEL)
        @Override
        ...
        @JsonProperty(DeviceResourceApi.DEVICE_ITEM_DESCRIPTION)
        @Override
        public String getDescriptionAsXml() {return super.getDescriptionAsXml();}

        @XmlElement(name = DeviceResourceApi.DEVICE_ITEM_TIMESTAMP)
        @JsonProperty(DeviceResourceApi.DEVICE_ITEM_TIMESTAMP)
        @Override
        public abstract Long getTimestamp();

        @XmlElement(name = DeviceResourceApi.DEVICE_ITEM_PREMIS)
        @JsonProperty(DeviceResourceApi.DEVICE_ITEM_PREMIS)
        @Override
        public String getAudioDescriptionXml() {
            return super.getAudioDescriptionXml();
        }

        @XmlElement(name = DeviceResourceApi.DEVICE_ITEM_AUDIO_TIMESTAMP)
        @JsonProperty(DeviceResourceApi.DEVICE_ITEM_AUDIO_TIMESTAMP)
        @Override
        public abstract Long getAudioTimestamp();

        @XmlElement(name = DeviceResourceApi.DEVICE_ITEM_MODEL)
        @JsonProperty(DeviceResourceApi.DEVICE_ITEM_MODEL)
        @Override
