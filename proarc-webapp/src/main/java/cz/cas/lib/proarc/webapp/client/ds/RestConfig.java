...
//    public static final String URL_ROOT =  "/rest";
    ...
    public static final String URL_CHANGE_NDK_MONOGRAPH_UNIT_TO_NDK_MONOGRAPH_VOLUME = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_MONOGRAPH_UNIT_TO_NDK_MONOGRAPH_VOLUME);
    ...
    public static final String URL_CHANGE_K4_MONOGRAPH_UNIT_TO_NDK_MONOGRAPH_UNIT = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_K4_MONOGRAPH_UNIT_TO_NDK_MONOGRAPH_UNIT);
    ...
    public static final String URL_CHANGE_STT_MONOGRAPHUNIT_TO_STT_MONOGRAPHVOLUME = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_STT_MONOGRAPH_UNIT_TO_STT_MONOGRAPH_VOLUME);
    public static final String URL_CHANGE_STT_MONOGRAPHVOLUME_TO_STT_MONOGRAPHUNIT = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_STT_MONOGRAPH_VOLUME_TO_STT_MONOGRAPH_UNIT);
    ...
    public static final String URL_CHANGE_NDK_PERIODICAL_TO_NDK_EPERIODICAL = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_PERIODICAL_TO_NDK_EPERIODICAL);
    public static final String URL_CHANGE_NDK_PERIODICAL_VOLUME_TO_NDK_EPERIODICAL_VOLUME = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_PERIODICAL_VOLUME_TO_NDK_EPERIODICAL_VOLUME);
    public static final String URL_CHANGE_NDK_PERIODICAL_ISSUE_TO_NDK_EPERIODICAL_ISSUE = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_PERIODICAL_ISSUE_TO_NDK_EPERIODICAL_ISSUE);
    public static final String URL_CHANGE_NDK_PERIODICAL_SUPPLEMENT_TO_NDK_EPERIODICAL_SUPPLEMENT = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_PERIODICAL_SUPPLEMENT_TO_NDK_EPERIODICAL_SUPPLEMENT);
    public static final String URL_CHANGE_NDK_ARTICLE_TO_NDK_EARTICLE = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_ARTICLE_TO_NDK_EARTICLE);
    public static final String URL_CHANGE_BDM_ARTICLE_TO_NDK_EARTICLE = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_BDM_ARTICLE_TO_NDK_EARTICLE);
    public static final String URL_CHANGE_NDK_EPERIODICAL_TO_NDK_PERIODICAL = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_EPERIODICAL_TO_NDK_PERIODICAL);
    public static final String URL_CHANGE_NDK_EPERIODICAL_VOLUME_TO_NDK_PERIODICAL_VOLUME = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_EPERIODICAL_VOLUME_TO_NDK_PERIODICAL_VOLUME);
    public static final String URL_CHANGE_NDK_EPERIODICAL_ISSUE_TO_NDK_PERIODICAL_ISSUE = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_EPERIODICAL_ISSUE_TO_NDK_PERIODICAL_ISSUE);
    public static final String URL_CHANGE_NDK_EPERIODICAL_SUPPLEMENT_TO_NDK_PERIODICAL_SUPPLEMENT = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_EPERIODICAL_SUPPLEMENT_TO_NDK_PERIODICAL_SUPPLEMENT);
    public static final String URL_CHANGE_NDK_EARTICLE_TO_NDK_ARTICLE = path(URL_DIGOBJECT, DigitalObjectResourceApi.CHANGE_NDK_EARTICLE_TO_NDK_ARTICLE);
