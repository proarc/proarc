...
/**
 * Change OldPrint Monograph Volume  to OldPrint Monograph Unit
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintMonographVolumeToOldPrintMonographUnitAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintMonographVolumeToOldPrintMonographUnitAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintMonographVolumeToOldPrintMonographUnitAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintMonographVolumeToOldPrintMonographUnitAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (OldPrintPlugin.MODEL_MONOGRAPHVOLUME.equals(modelId)) || OldPrintPlugin.MODEL_MONOGRAPHTITLE.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintMonographVolumeToOldPrintMonographUnit();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintMonographVolumeToOldPrintMonographUnitAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
