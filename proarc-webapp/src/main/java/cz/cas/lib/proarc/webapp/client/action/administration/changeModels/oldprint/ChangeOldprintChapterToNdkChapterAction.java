...
/**
 * Change OldPrint Chapter to Ndk Chapter
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintChapterToNdkChapterAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintChapterToNdkChapterAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintChapterToNdkChapterAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintChapterToNdkChapterAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && OldPrintPlugin.MODEL_CHAPTER.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintChapterToNdkChapter();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintChapterToNdkChapterAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
