...
/**
 * Change Ndk Cartographic to OldPrint Cartographic
 *
 * @author Lukas Sykora
 */
public class ChangeNdkCartographicToOldprintCartographicAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkCartographicToOldprintCartographicAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkCartographicToOldPrintCartographicAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkCartographicToOldprintCartographicAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && NdkPlugin.MODEL_CARTOGRAPHIC.equals(modelId)) {
                    accept = true;
                    continue;
                }
            }
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkCartographicToOldPrintCartographic();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkCartographicToOldPrintCartographicAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
