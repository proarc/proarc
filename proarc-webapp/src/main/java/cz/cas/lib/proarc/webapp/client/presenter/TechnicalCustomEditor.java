...
public class TechnicalCustomEditor extends AbstractDatastreamEditor implements RefreshAction.Refreshable {

    private static final Logger LOG = Logger.getLogger(TechnicalCustomEditor.class.getName());
    ...
    public TechnicalCustomEditor(ClientMessages i18n) {
        this.i18n = i18n;
    ...
    private DynamicForm createCustomForm(MetaModelDataSource.MetaModelRecord model) {
        ...
        form = new TechnicalMetadataForms(i18n).getForm(model);
        if (form == null) {
