...
/**
 * Change Ndk Music sheet to OldPrint Music Sheet
 *
 * @author Lukas Sykora
 */
public class ChangeNdkMusicsheetToOldprintMusicsheetAction extends AbstractAction {
    ...
    public ChangeNdkMusicsheetToOldprintMusicsheetAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkMusicSheetToOldPrintMusicSheet();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkMusicSheetToOldPrintMusicSheetAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
