...
/**
 * Change Ndk EArticle to BDM Article
 *
 * @author Lukas Sykora
 */
public class ChangeNdkEArticleToBdmArticleAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkEArticleToBdmArticleAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkEArticleToBdmArticleAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkEArticleToBdmArticleAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeNdkEArticleToBdmArticle();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkEArticleToBdmArticleAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
