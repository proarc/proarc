...
public class TechnicalCustomDataSource extends ProarcDataSource implements ModsConstants {
    ...
    public void saveXmlDescription(DigitalObjectDataSource.DigitalObject dobj, String xml, DescriptionSaveHandler callback) {
        saveXmlDescription(dobj, xml, -1, callback);
    }

    public void saveXmlDescription(DigitalObjectDataSource.DigitalObject dobj, String xml, long timestamp, DescriptionSaveHandler callback) {
        saveXmlDescription(dobj, xml, timestamp, callback, false);
    }

    public void saveXmlDescription(DigitalObjectDataSource.DigitalObject dobj, String xml, long timestamp, DescriptionSaveHandler callback, Boolean ignoreValidation) {
    ...
    public static class DescriptionMetadata {
        ...
        public DigitalObjectDataSource.DigitalObject getDigitalObject() {
            return DigitalObjectDataSource.DigitalObject.create(wrapper);
        }
