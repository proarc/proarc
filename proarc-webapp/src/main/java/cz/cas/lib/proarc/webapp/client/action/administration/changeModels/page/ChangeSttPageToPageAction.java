 ...
 * @author Lukas Sykora
 */
public class ChangeSttPageToPageAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeSttPageToPageAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeSttPageToPageAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeSttPageToPageAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeSttPageToPage();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeSttPageToPageAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
