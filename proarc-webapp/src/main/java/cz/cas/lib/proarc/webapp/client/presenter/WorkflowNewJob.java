...
public class WorkflowNewJob {
    ...
    public void onCreateNew(String modelPid, Record query) {
        ...
        WorkflowJobDataSource.getInstance().addData(query, new DSCallback() {
            ...
            public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
                if (RestConfig.isStatusOk(dsResponse)) {
                    ...
                    //TODO-MR After saving, go back
                    //places.goTo(new WorkflowJobPlace().setJobId(jobId));
                    places.goTo(new WorkflowManaging.WorkflowNewJobEditPlace().setJobId(jobId).setModelPid(modelPid));
                } else {
