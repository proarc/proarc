...
/**
 * Change OldPrint Monograph Volume  to OldPrint MusicSheet
 *
 * @author Lukas Sykora
 */
public class ChangeOldprintMonographVolumeToOldPrintMusicSheetAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeOldprintMonographVolumeToOldPrintMusicSheetAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeOldPrintMonographVolumeToOldPrintMusicSheetAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeOldprintMonographVolumeToOldPrintMusicSheetAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeOldPrintMonographVolumeToOldPrintMusicSheet();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeOldPrintMonographVolumeToOldPrintMusicSheetAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
