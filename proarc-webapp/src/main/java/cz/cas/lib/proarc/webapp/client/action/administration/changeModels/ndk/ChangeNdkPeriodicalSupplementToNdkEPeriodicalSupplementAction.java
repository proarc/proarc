...
/**
 * Change Ndk Periodical Supplement to Ndk EPeriodical Supplement
 *
 * @author Lukas Sykora
 */
public class ChangeNdkPeriodicalSupplementToNdkEPeriodicalSupplementAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeNdkPeriodicalSupplementToNdkEPeriodicalSupplementAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeNdkPeriodicalSupplementToNdkEPeriodicalSupplementAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeNdkPeriodicalSupplementToNdkEPeriodicalSupplementAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (NdkPlugin.MODEL_PERIODICALSUPPLEMENT.equals(modelId) || NdkPlugin.MODEL_PERIODICALISSUE.equals(modelId)
                        || NdkPlugin.MODEL_PERIODICALVOLUME.equals(modelId) || NdkPlugin.MODEL_PERIODICAL.equals(modelId)
                        || NdkEbornPlugin.MODEL_EPERIODICAL.equals(modelId) || NdkEbornPlugin.MODEL_EPERIODICALVOLUME.equals(modelId)
        ...
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeNdkPeriodicalSupplementToNdkEPeriodicalSupplementAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
