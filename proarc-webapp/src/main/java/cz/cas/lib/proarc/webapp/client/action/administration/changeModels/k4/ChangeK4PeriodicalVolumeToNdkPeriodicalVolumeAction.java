...
/**
 * Change K4 Periodical Volume to Ndk Periodical Volume
 *
 * @author Lukas Sykora
 */
public class ChangeK4PeriodicalVolumeToNdkPeriodicalVolumeAction extends AbstractAction {

    private final ClientMessages i18n;

    public ChangeK4PeriodicalVolumeToNdkPeriodicalVolumeAction(ClientMessages i18n) {
        this(i18n, i18n.ChangeK4PeriodicalVolumeToNdkPeriodicalVolumeAction_Title(),
                "[SKIN]/headerIcons/transfer.png",
                i18n.ChangeModelAction_Hint());
    }

    public ChangeK4PeriodicalVolumeToNdkPeriodicalVolumeAction(ClientMessages i18n, String title, String icon, String tooltip) {
    ...
    private boolean acceptModel(Record[] records) {
        ...
        for (Record record : records) {
            ...
            if (dobj != null) {
                ...
                if (modelId != null && (K4Plugin.MODEL_PERIODICALVOLUME.equals(modelId) ||
    ...
    private void changeModel(Record record) {
        ...
        ChangeModelsDataSource ds = ChangeModelsDataSource.changeK4PeriodicalVolumeToNdkPeriodicalVolume();
        ds.addData(record, new DSCallback() {
            ...
            public void execute(DSResponse response, Object rawData, DSRequest request) {
                if (hasValidationError(response)) {
                    ...
                    StatusView.getInstance().show(i18n.ChangeK4PeriodicalVolumeToNdkPeriodicalVolumeAction_FinishStep_Msg());
                }
            }
        }, dsRequest);
    }
