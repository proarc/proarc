 ...
 *       &lt;sequence>
 *         &lt;element name="Schvaleni" type="{http://www.mvcr.cz/nsesss/v2}tSchvaleni" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TSchvalovani {
    ...
    @XmlElement(name = "Schvaleni", namespace = "http://www.mvcr.cz/nsesss/v2", required = true)
    protected List<TSchvaleni> schvaleni;
    ...
    public List<TSchvaleni> getSchvaleni() {
        if (schvaleni == null) {
            schvaleni = new ArrayList<TSchvaleni>();
        }
        return this.schvaleni;
    }
