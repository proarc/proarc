...
public final class BinaryEditor {
    ...
    public static BinaryEditor preview(ProArcObject object) {
        DatastreamProfile dp = FoxmlUtils.managedProfile(PREVIEW_ID, IMAGE_JPEG, PREVIEW_LABEL);
        return new BinaryEditor(object, dp);
    }

    public static BinaryEditor dissemination(ProArcObject object, String dsId) {
        return dissemination(object, dsId, IMAGE_JPEG);
    }

    public static BinaryEditor dissemination(ProArcObject object, String dsId, MediaType mime) {
