...
public final class ImportFileScanner {
    ...
    public static void validateImportFolder(File folder) throws FileNotFoundException, IllegalArgumentException {
        if (!folder.exists()) {
    ...
    public static final class Folder {
        ...
        public State getStatusNdk(AppConfiguration appConfig) {
            if (statusNdk == null) {
                statusNdk = folderImportState(handle, createImporter(appConfig, ConfigurationProfile.DEFAULT_NDK_IMPORT));
            }
            return statusNdk;
        }
