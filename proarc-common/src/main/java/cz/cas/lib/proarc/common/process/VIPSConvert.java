...
/**
 * Uses VIPS for converting large jpg images to tiff
 *
 * @author Jakub Kremlacek
 */
public class VIPSConvert extends ExternalProcess {
    public static final String ID = "batch_image_convert";
    ...
    public VIPSConvert (Configuration conf, File input, File output) {
        super(conf);
        this.input = input;
        this.output = output;
    }
