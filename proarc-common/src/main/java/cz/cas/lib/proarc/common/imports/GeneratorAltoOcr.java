...
import static cz.cas.lib.proarc.common.process.OcrGenerator.getOcrFiles;
...
public class GeneratorAltoOcr implements ImportHandler {
    ...
    @Override
    public void start(ImportProcess.ImportOptions importConfig, ImportBatchManager batchManager, AppConfiguration config) throws Exception {
