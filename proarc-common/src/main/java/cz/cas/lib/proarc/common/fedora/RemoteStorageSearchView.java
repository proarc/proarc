 ...
 * @author Jan Pokorsky
 */
public final class RemoteStorageSearchView extends SearchView {

    private static final Logger LOG = Logger.getLogger(RemoteStorageSearchView.class.getName());
    ...
    RemoteStorageSearchView(RemoteStorage storage) {
        this(storage, Integer.MAX_VALUE);
    }

    RemoteStorageSearchView(RemoteStorage storage, int maxLimit) {
