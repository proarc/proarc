...
public final class SearchView {
    ...
    public List<Item> findAdvanced(String identifier, String label, String status, String organization, String processor, String model, String creator,  String sortField, String sort, int offset, int limit) throws IOException, FedoraClientException {
        sortField = createSortField(sortField);
        sort = createSort(sort);
        List<String> pids = findAdvancedPids(new Query().setLabel(label).setIdentifier(identifier).setModel(model).setCreator(creator));
        return findAdvancedObjects(pids, status, organization, processor, sortField + " " + sort, offset, limit);
    }


    public int findAdvancedSearch(String identifier, String label, String status, String organization, String processor, String model, String creator) throws FedoraClientException, IOException {
        List<String> pids = findAdvancedPids(new Query().setLabel(label).setIdentifier(identifier).setModel(model).setCreator(creator));
    ...
    private List<String> findAdvancedPids(Query q) throws FedoraClientException {
        ...
        buildQuery(query, "label", q.getLabel());
        buildQuery(query, "ownerId", q.getCreator());
        buildQuery(query, "identifier", q.getIdentifier());
