...
public interface ImportHandler {
     ...
     */
    int estimateItemNumber(ImportProcess.ImportOptions importConfig) throws IOException;
     ...
     */
    void start(ImportProcess.ImportOptions importConfig, BatchManager batchManager, AppConfiguration config) throws Exception;
