...
public class ProarcDatabaseV19 extends DBDatabase {
    ...
    public static int upgradeToVersion20(
        ...
        if (currentSchemaVersion < VERSION) {
            ...
            currentSchemaVersion = ProarcDatabaseV18.upgradeToVersion19(currentSchemaVersion, context, conf);
        }
        if (currentSchemaVersion > VERSION) {
...
//            schema.close(context);
    ...
    private static void upgradeDdl(ProarcDatabase schema, DBContext context) throws SQLException {
        try {
            ...
            context.getDbms().getDDLScript(DBDDLGenerator.DDLActionType.CREATE, schema.tableBatch.nightOnly, script);
