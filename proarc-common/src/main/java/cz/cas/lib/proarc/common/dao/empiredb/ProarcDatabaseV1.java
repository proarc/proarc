 ...
 *
 * <p><b>Use only for tests and upgrade purposes!</b>
 *
 * @author Jan Pokorsky
 */
public class ProarcDatabaseV1 extends DBDatabase {
    ...
    public static int upgradeVersion1(ProarcDatabase schema, Connection conn) throws SQLException {
        ...
        try {
            ...
            int schemaVersion = 2;
            schema.initVersion(conn, schemaVersion);
...
//            conn.setAutoCommit(false);
    ...
    private static void upgradeGroups(ProarcDatabase schema, ProarcDatabaseV1 schemaV1, Connection conn) {
    ...
    private static void upgradeUsers(ProarcDatabase schema, ProarcDatabaseV1 schemaV1, Connection conn) {
