...
public class ImportUtils {
    ...
    public static boolean createPidHierarchy(List<ImportBatchManager.BatchItemObject> batchItems, String documentPid, ArrayList<Hierarchy> songsPid, ArrayList<ArrayList<Hierarchy>> tracksPid, List<String> pids) {
        pids.clear();
        String pid = "";

        batchItems = sortBatchItems(batchItems);

        for (ImportBatchManager.BatchItemObject batchItem : batchItems) {
    ...
    private static List<ImportBatchManager.BatchItemObject> sortBatchItems(List<ImportBatchManager.BatchItemObject> batchItems) {

        Map<String, ImportBatchManager.BatchItemObject> sortedList = new TreeMap<String, ImportBatchManager.BatchItemObject>();
