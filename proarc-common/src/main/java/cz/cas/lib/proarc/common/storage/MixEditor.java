...
public class MixEditor {
     ...
     */
    public static MixEditor ndkArchival(ProArcObject object) {
     ...
     * about the scanner.
     */
    public static MixEditor raw(ProArcObject object) {
        return new MixEditor(object, rawProfile());
    }

    public MixEditor(ProArcObject object, DatastreamProfile profile) {
