...
public abstract class SearchView {
    ...
    public List<SearchViewItem> findByOwner(String owner) throws FedoraClientException, IOException {
        return findAdvancedSearchItems(true, null, null, owner, null, null, null, null, null, null, null, "label", "desc", 0, Integer.MAX_VALUE);
    }

    public List<SearchViewItem> findByProcessor(String processor) throws FedoraClientException, IOException {
        return findAdvancedSearchItems(true, null, null, null, null, null, processor, null, null, false, null, "label", "desc", 0, Integer.MAX_VALUE);
    }
