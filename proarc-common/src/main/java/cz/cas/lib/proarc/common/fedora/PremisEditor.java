...
public class PremisEditor {
     ...
     */
    public static PremisEditor ndkArchival(FedoraObject object) {
     ...
     * about the scanner.
     */
    public static PremisEditor raw(FedoraObject object) {
        return new PremisEditor(object, rawProfile());
    }

    public PremisEditor(FedoraObject object, DatastreamProfile profile) {
...
//        }
    ...
    public Mets generate(FedoraObject fobject, AppConfiguration config, AkubraConfiguration akubraConfiguration, String importFile) throws DigitalObjectException {
        try {
