...
public class AcceptedExports {
    ...
    private List<String> ALL_MODELS = Arrays.asList(
            ...
            // K4 //
            K4Plugin.MODEL_MONOGRAPH, K4Plugin.MODEL_MONOGRAPHUNIT, K4Plugin.MODEL_PERIODICAL, K4Plugin.MODEL_PERIODICALITEM, K4Plugin.MODEL_PERIODICALVOLUME, K4Plugin.MODEL_ARTICLE,
            K4Plugin.MODEL_MAP, K4Plugin.MODEL_SUPPLEMENT, K4Plugin.MODEL_PICTURE, K4Plugin.MODEL_SHEETMUSIC, K4Plugin.MODEL_INTERNALPART, K4Plugin.MODEL_GRAPHIC,
            K4Plugin.MODEL_CONVOLUTE, K4Plugin.MODEL_SOUNDRECORDING, K4Plugin.MODEL_SOUNDUNIT, K4Plugin.MODEL_TRACK
    );
