...
//            queueNumber = addColumn("QUEUE_NUMBER", DataType.DECIMAL, 0, true);
    ...
    static int schemaExists(ProarcDatabase db, DBContext context) {
        try {
    ...
    private static void createSchema(ProarcDatabase db, DBContext context) throws SQLException {
