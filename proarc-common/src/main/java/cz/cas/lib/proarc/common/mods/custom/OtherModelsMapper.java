 ...
 * @author Lukas Sykora
 */
final class OtherModelsMapper implements Mapper<OtherModelsMapper.OtherModels> {

    @Override
    public OtherModels map(ModsDefinition mods) {
        NodeLookup nlookup = new NodeLookup(mods);
        OtherModels result = new OtherModels();
        // identifiers
    ...
    @Override
    public ModsDefinition map(ModsDefinition mods, OtherModels monograph) {
                NodeLookup nlookup = new NodeLookup(mods);
        // identifiers
        IdentifierMapper identMap = new IdentifierMapper();
