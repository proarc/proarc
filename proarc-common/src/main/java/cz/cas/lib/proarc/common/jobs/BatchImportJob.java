        ...
        for (ImportFileScanner.Folder folder : folders) {
            ...
            try {
                ...
                process = ImportProcess.prepare(folder.getHandle(), folder.getHandle().getName(), user,
                        BatchManager.getInstance(), deviceUUID, null, true, Batch.PRIORITY_MEDIUM, false, false, null, null, false, null, appConfig.getImportConfiguration(profile), appConfig);
