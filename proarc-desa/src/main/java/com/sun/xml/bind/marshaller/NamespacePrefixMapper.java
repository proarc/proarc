...
public abstract class NamespacePrefixMapper {
     ...
     * {@link javax.xml.bind.JAXBContext} includes classes that use the empty
     * namespace URI. This allows the JAXB RI to reserve the "" prefix for the
     * empty namespace URI, which is the only possible prefix for the URI. This
     * restriction is also to simplify the marshaller.
     * </ol>
     * 
     * @param namespaceUri
     ...
     * {@link javax.xml.transform.dom.DOMResult}, or {@link org.w3c.dom.Node},
     * because those output format allows us to inspect what's currently
     * available as in-scope namespace binding. However, with other output
     * format, such as {@link java.io.OutputStream}, the JAXB RI cannot do this
